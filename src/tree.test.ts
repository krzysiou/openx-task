import { numberOfLeaves, longestPathEdgeCount, areTreesEqual, Tree } from './tree'

//generate tree of given height and random values (testing utility)
function generateTree(height: number): Tree<number> {
